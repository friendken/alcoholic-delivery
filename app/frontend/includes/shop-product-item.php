...
<li
  class="product type-product status-publish first instock product_cat-rose product_tag-brandy product_tag-drink product_tag-italy product_tag-new has-post-thumbnail sale shipping-taxable purchasable product-type-simple">
  <div class="w-product-inner">
    ...
    <div class="w-product-content">
      ...
      <div class="w-product-price price">
        <ins>
          <span class="w-price-amount amount"><?php echo $item->price ?><span class="w-price-currencySymbol"><?php echo $item->currency ?></span></span>
        </ins>
      </div>
    </div>
